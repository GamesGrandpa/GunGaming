...
namespace GunGaming.Accessories
{
	...
	public abstract class crimAccessory1 : ModItem
	{
		...
		public override bool CanEquipAccessory(Player player, int slot)
		{
			...
			if (slot < 10) // This allows the accessory to equip in vanity slots with no reservations
			{
				...
				int index = FindDifferentEquippedcrimAccessory1().index;
				if (index != -1)
				{
					return slot == index;
				}
		...
		public override void ModifyTooltips(List<TooltipLine> tooltips)
		{
			...
			Item accessory = FindDifferentEquippedcrimAccessory1().accessory;
			if (accessory != null)
			{
		...
		public override bool CanRightClick()
		{
			...
			if (FindDifferentEquippedcrimAccessory1().accessory != null)
			{
				return true;
			}
		...
		public override void RightClick(Player player)
		{
			...
			var (index, accessory) = FindDifferentEquippedcrimAccessory1();
			if (accessory != null)
			{
		...
		protected (int index, Item accessory) FindDifferentEquippedcrimAccessory1()
		{
			int maxAccessoryIndex = 5 + Main.LocalPlayer.extraAccessorySlots;
			for (int i = 3; i < 3 + maxAccessoryIndex; i++)
			{
				...
				if (!otherAccessory.IsAir &&
					...
					otherAccessory.modItem is crimAccessory1)
				{
	...
	public class crimAccessory2 : crimAccessory1
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Crimson Anklet");
			Tooltip.SetDefault("Increase Damage by 5% and Move Speed by 10%");
		}
