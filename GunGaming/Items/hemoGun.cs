...
{
	public class hemoGun : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Hemo Gunbin"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
		...
		public override void AddRecipes() 
		{
			...
			recipe.AddIngredient(ModContent.ItemType<goldGun>(), 1);
