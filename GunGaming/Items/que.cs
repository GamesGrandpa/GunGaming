...
{
	public class que : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Scrap Gun"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
			Tooltip.SetDefault("You might want a tetanus shot");
		}
